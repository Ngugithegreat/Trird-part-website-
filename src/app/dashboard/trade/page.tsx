...
export default function ManualTraderPage() {
  ...
  return (
    <div style={{ height: 'calc(100vh - 96px)', width: '100%', position: 'relative', overflow: 'hidden' }}>
      {/*
        This iframe loads app.deriv.com/dtrader with the user's token.
        The user trades on THEIR account via our interface.
        We hide Deriv's navbar using a transparent overlay on top.
      */}
      <iframe
        src={src}
